...
df = df.drop(columns=["XFER Cases"], errors="ignore")
...
emailer.send_xlsx_report(
    ...
    recipients=["BHopkins@russdaviswholesale.com", "jgraybill@russdaviswholesale.com", "BFihn@russdaviswholesale.com",
                "kmoran@russdaviswholesale.com", "mconstantine@russdaviswholesale.com", "RGraham@russdaviswholesale.com"],
    subject=f"[Automated Email] - Branch Labor {last_weeks_sunday()}",
    body_text=f"Attached is the Branch Labor report with {last_weeks_sunday()}'s data included. XFER Cases are included in the dashboard, which is updated at https://app.fabric.microsoft.com/Redirect?action=OpenReport&appId=9697931f-34f4-4455-9f12-899a76da3500&reportObjectId=6f81a386-86ae-407f-a465-1ea2c94363a4&ctid=549e5d19-024b-4b10-ac2e-58d96a47fe41&reportPage=2e8287b652b5c7df63c6&pbi_source=appShareLink&portalSessionId=1592bd68-f3bb-41c2-aae6-f24cac25c233 \n\nPlease reach out to Jake if you need a new dashboard link or if there's any issues with the report.",
    sheet_name=f"Summary",
    index=False,
    attachment_filename=f"Branch_Labor_{last_weeks_sunday()}.xlsx",
    cc=["jsommerfeldt@russdaviswholesale.com"],
    bcc=None,
    reply_to=None,
)
"""